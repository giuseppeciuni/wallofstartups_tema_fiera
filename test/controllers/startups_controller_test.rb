...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { description: @startup.description, rank: @startup.rank, title: @startup.title, video_url: @startup.video_url }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { description: @startup.description, rank: @startup.rank, title: @startup.title, video_url: @startup.video_url }
    assert_redirected_to startup_path(assigns(:startup))
  end
